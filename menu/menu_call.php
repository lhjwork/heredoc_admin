            ...
            ?>	
                ...
                <li>
                    ...
                    <a href="<?echo $host;?>/call/doc.php?doc=<?echo $row['t_doc'];?>">
                        <i class="fa fa-edit"></i>
                        <span><?echo $row['t_name'];?> 상담페이지</span>
                    </a>
		...
		<ul class="treeview-menu">
            ...
            <li>
                <a href="<?echo $host;?>/call/calenddar_doc.php?doc=<?echo $row['t_doc'];?>">
                    <i class="fa fa-edit"></i>
                    <span><?echo $row['t_name'];?>달력현황</span>
                </a>
            </li>
...
<ul class="sidebar-menu" data-widget="tree">
	...
	<li class="treeview">
		...
		<a href="#">
			<i class="fa fa-files-o"></i>
			<span><?echo $t_member_team;?> 상담페이지</span>
			<span class="pull-right-container">
				<i class="fa fa-angle-left pull-right"></i>
			</span>
		</a>
	...
	<li class="treeview">
		...
		<a href="#">
			<i class="fa fa-files-o"></i>
			<span><?echo $t_member_team;?> 병원 달력</span>
			<span class="pull-right-container">
				<i class="fa fa-angle-left pull-right"></i>
			</span>
		</a>
